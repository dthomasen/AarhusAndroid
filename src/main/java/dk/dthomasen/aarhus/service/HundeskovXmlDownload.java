 ...
 */
public class HundeskovXmlDownload extends AsyncTask<Context, Void, Boolean>{
    ...
    protected Boolean doInBackground(Context... params) {
        try {
            ...
            String xml = getXML("http://dthomasen.dk/aarhus/hundeskove/hundeskove.xml");
            writeToFile("hundeskove.xml",xml);
            return true;
        } catch (Throwable t) {
