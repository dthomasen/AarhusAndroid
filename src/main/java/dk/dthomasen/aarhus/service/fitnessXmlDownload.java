 ...
 */
public class FitnessXmlDownload extends AsyncTask<Context, Void, Boolean>{
    ...
    protected Boolean doInBackground(Context... params) {
        try {
            ...
            String xml = getXML("http://dthomasen.dk/aarhus/fitness/fitness.xml");
            writeToFile("fitness.xml",xml);
            return true;
        } catch (Throwable t) {
