 ...
 */
public class ShelterCommentUpload extends AsyncTask<Integer, Void, ShelterRating> {
    ...
    public ShelterCommentUpload(Activity activity, ShelterRating message) {
    ...
    protected void onPostExecute(ShelterRating result) {
        if(result != null){
            ...
            new ShelterCommentsDownload(((CardUI) activity.findViewById(R.id.commentsCardView)), activity).execute(1, Integer.parseInt(message.getShelter_id()));
        }else{
