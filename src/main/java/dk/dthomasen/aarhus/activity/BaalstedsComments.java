...
import dk.dthomasen.aarhus.service.BaalstedCommentUpload;
import dk.dthomasen.aarhus.service.Service;

/**
 * Created by Dennis on 04-07-13.
 */
public class BaalstedsComments extends Activity implements View.OnClickListener{
    protected final String TAG = this.getClass().getName();
    private SlidingMenu slidingMenu;
    private Activity activity = this;
    private int baalstedId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        baalstedId = intent.getExtras().getInt("baalstedid");
    ...
    public void populateCards(){
        ...
        BaalstedRatings result = Service.getInstance().getSavedBaalstedRatings();
        ...
        if(v.getId() == R.id.ABAddComment){
            ...
            postButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    BaalstedRating comment = new BaalstedRating();
                    comment.setBaalsted_id(Integer.toString(baalstedId));
                    ...
                    new BaalstedCommentUpload(activity, comment).execute(1);
